...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $user->has('division') ? $this->Html->link($user->division->name, ['controller' => 'Divisions', 'action' => 'view', $user->division->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><?= __('Authority Id') ?></th>
            <td><?= $this->Number->format($user->authority_id) ?></td>
        </tr>
        <tr>
